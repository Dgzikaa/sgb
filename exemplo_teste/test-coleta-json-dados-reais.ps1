...
Write-Host "Testando coleta JSON com periodo recente (junho 2024)..."
Write-Host "URL: $url"
Write-Host "Body: $body"
Write-Host "Objetivo: Testar chunking com dados reais"
