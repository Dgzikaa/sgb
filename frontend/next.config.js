        ...
        headers: [
          ...
          },
          {
            ...
            value: process.env.NODE_ENV === 'development' 
              ...
              : "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' blob:; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https:; connect-src 'self' https: wss:; font-src 'self' data: https:; worker-src 'self' blob:; frame-ancestors 'none';",
          },
        ],
      },
    ];
