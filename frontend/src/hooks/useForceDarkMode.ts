    ...
    const applyDarkModeForce = () => {
      ...
      elements.forEach(el => {
        ...
        if (
          ...
          !el.classList.contains('dark:bg-gray-600')
        ) {
      ...
      textElements.forEach(el => {
        ...
        if (
          ...
          !el.classList.contains('dark:text-gray-300')
        ) {
        ...
        if (
          ...
          !el.classList.contains('dark:text-gray-500')
        ) {
          el.classList.add('dark:text-gray-500');
        }
        if (
          el.classList.contains('text-gray-400') &&
          !el.classList.contains('dark:text-gray-600')
        ) {
      ...
      borderElements.forEach(el => {
        ...
        if (
          el.classList.contains('border-gray-300') &&
          !el.classList.contains('dark:border-gray-600')
        ) {
          el.classList.add('dark:border-gray-600');
        }
        if (
          el.classList.contains('border-gray-400') &&
          !el.classList.contains('dark:border-gray-500')
        ) {
