...
export function useSGBAssistant() {
  ...
  const toggleAssistant = () => {
    setState(prev => ({
      ...prev,
      isOpen: !prev.isOpen,
      hasNewMessages: prev.isOpen ? false : prev.hasNewMessages, // Limpar notificaÃ¡Â§Ã¡Â£o ao abrir
  ...
  const addNotification = () => {
    setState(prev => ({
      ...prev,
      hasNewMessages: !prev.isOpen // SÃ¡Â³ mostrar notificaÃ¡Â§Ã¡Â£o se estiver fechado
    }))
  }
