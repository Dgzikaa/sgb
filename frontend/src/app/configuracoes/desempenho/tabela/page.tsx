...
export default function TabelaDesempenhoPage() {
  ...
  const limparTodosDados = async () => {
    if (!confirm('🚫 ATENÇÃO: Isso irá excluir TODOS os dados de desempenho deste bar. Esta ação não pode ser desfeita!\n\nTem certeza que deseja continuar?')) {
      return
    }
    ...
    try {
      ...
      alert(`❌ Erro ao limpar dados: ${error instanceof Error ? error.message : String(error)}`);
    }
  }
