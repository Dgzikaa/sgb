...
export default function InterCertificadosPage() {
  ...
  const [certStatus, setCertStatus] = useState<'checking' | 'found' | 'missing'>('checking')
  ...
  const checkCertificates = async () => {
    ...
    try {
      ...
      if (data.error && data.error.includes('Certificados do Inter não configurados')) {
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Configure os certificados necessários para integração com o Banco Inter
            </p>
          </div>
          ...
          <Card className="card-dark">
            <CardHeader>
              <CardTitle className="card-title-dark">Como Obter os Certificados</CardTitle>
            </CardHeader>
            <CardContent className="space-y-3">
              <div className="text-sm text-gray-600 dark:text-gray-400">
                <p><strong>1.</strong> Acesse o portal de desenvolvedores do Banco Inter</p>
                <p><strong>2.</strong> Vá em "Certificados" ou "mTLS"</p>
                <p><strong>3.</strong> Gere ou baixe os certificados necessários</p>
                <p><strong>4.</strong> Faça upload dos arquivos acima</p>
                <p><strong>5.</strong> Os certificados serão salvos em <code className="bg-gray-100 dark:bg-gray-700 px-1 rounded">frontend/pages/api/</code></p>
              </div>
            </CardContent>
          </Card>
