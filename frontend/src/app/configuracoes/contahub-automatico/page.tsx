...
export default function ContaHubAutomaticoPage() {
  ...
  useEffect(() => {
    setPageTitle('ðŸ¤– ContaHub Automá¡tico')
    verificarContaHub()
    return () => setPageTitle('')
  }, [setPageTitle])
  ...
  const executarColetaAutomatica = async () => {
    if (!dataInicio || !dataFim) {
      toast({
        title: "Œ Erro",
        description: "Por favor, selecione as datas de iná­cio e fim",
        variant: "destructive"
      })
      return
    }
    ...
    try {
      ...
      toast({
        title: "Œ Erro",
        description: error instanceof Error ? error.message : "Erro ao executar coleta automá¡tica",
        variant: "destructive"
      })
    } finally {
      setExecutando(false)
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h1 className="text-3xl font-bold">ContaHub Automá¡tico</h1>
                    <p className="text-cyan-100 mt-1">Coleta automá¡tica de dados financeiros em lote</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                <div className="text-right">
                  <div className="text-sm text-cyan-200">Status do Serviá§o</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <Card className="bg-white dark:bg-gray-800 border-0 shadow-lg hover:shadow-xl transition-all duration-300">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Perá­odo (dias)</p>
                  <p className="text-3xl font-bold text-gray-900 dark:text-white">
                    {calcularDias()}
                  </p>
        ...
        <Card className="bg-white dark:bg-gray-800 border-0 shadow-lg">
          <CardHeader className="border-b border-gray-100 dark:border-gray-700 pb-4">
            <CardTitle className="flex items-center gap-3 text-gray-900 dark:text-white">
              ...
              Configuraá§á£o da Coleta Automá¡tica
            </CardTitle>
            <CardDescription>
              Configure o perá­odo para coleta automá¡tica de dados do ContaHub
            </CardDescription>
          </CardHeader>
          <CardContent className="p-6">
            ...
            {!contahubDisponivel && (
              <div className="mt-6 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-red-800 dark:text-red-200">ContaHub Indisponá­vel</h4>
                    <p className="text-sm text-red-600 dark:text-red-300 mt-1">
                      O serviá§o ContaHub ná£o está¡ disponá­vel. Verifique a configuraá§á£o ou tente novamente mais tarde.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <CardContent className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="text-center p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400">Tempo de Execuá§á£o</div>
                </div>
              </div>
