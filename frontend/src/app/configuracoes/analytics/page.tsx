...
export default function AnalyticsPage() {
  ...
  const refreshMetrics = async () => {
    try {
      ...
      // Primeiro atualizar má©tricas via POST
      ...
      console.error('Erro ao atualizar má©tricas:', error)
    }
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <option value="7">ášltimos 7 dias</option>
              <option value="30">ášltimos 30 dias</option>
              <option value="90">ášltimos 90 dias</option>
            </select>
        ...
        {/* Cards de Má©tricas Principais */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <DashboardCard
            title="Usuá¡rios Ativos Hoje"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <DashboardCard
            ...
            subtitle={`${data?.alertas_resumo.criticos || 0} crá­ticos`}
        ...
        {/* Footer com áºltima atualizaá§á£o */}
        <div className="text-center text-sm text-gray-500 dark:text-gray-400">
          ášltima atualizaá§á£o: {data?.data_ultima_atualizacao ? 
