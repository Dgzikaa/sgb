...
export default function ContaAzulFinanceiroPage() {
  ...
  const carregarDados = async () => {
    ...
    try {
      ...
      // 2. Carregar contas a receber (áºltimas 100)
      ...
      // 3. Carregar contas a pagar (áºltimas 100)
      ...
      // 5. Verificar áºltima sincronizaá§á£o
    ...
    <div className="p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        <p className="text-gray-600">
          ášltima sincronizaá§á£o: {ultimaSync || 'Nunca sincronizado'}
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
          <h3 className="text-lg font-semibold text-blue-800 mb-2">œ… Receber - Pago</h3>
        ...
        <div className="bg-purple-50 p-6 rounded-lg border border-purple-200">
          <h3 className="text-lg font-semibold text-purple-800 mb-2">œ… Pagar - Pago</h3>
      ...
      <div className="mb-6 flex flex-wrap gap-4">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Visualizaá§á£o:</label>
          <select
              ...
              <table className="min-w-full">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Descriá§á£o</th>
