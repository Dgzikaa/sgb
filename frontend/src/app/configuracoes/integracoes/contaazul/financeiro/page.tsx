...
export default function ContaAzulFinanceiroPage() {
  ...
  useEffect(() => {
    setPageTitle('üí∞ ContaAzul - Dashboard Financeiro')
    return () => setPageTitle('')
  }, [setPageTitle])
  ...
  const carregarDados = async () => {
    ...
    try {
      ...
      // 5. Verificar ·∫ltima sincroniza·ß·£o
    ...
    return (
      <div className="p-8">
        <div className="text-center">
          <div className="text-lg">üîÑ Carregando dados financeiros...</div>
        </div>
      </div>
    )
  }
    ...
    <div className="p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        <p className="text-gray-600">
          ·öltima sincroniza·ß·£o: {ultimaSync || 'Nunca sincronizado'}
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-green-50 p-6 rounded-lg border border-green-200">
          <h3 className="text-lg font-semibold text-green-800 mb-2">üì• Receber - Total</h3>
        ...
        <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
          <h3 className="text-lg font-semibold text-blue-800 mb-2">úÖ Receber - Pago</h3>
          <p className="text-2xl font-bold text-blue-600">{formatCurrency(summary.receber_pago)}</p>
        </div>

        <div className="bg-red-50 p-6 rounded-lg border border-red-200">
          <h3 className="text-lg font-semibold text-red-800 mb-2">üì§ Pagar - Total</h3>
        ...
        <div className="bg-purple-50 p-6 rounded-lg border border-purple-200">
          <h3 className="text-lg font-semibold text-purple-800 mb-2">úÖ Pagar - Pago</h3>
      ...
      <div className="mb-6 flex flex-wrap gap-4">
        <div>
          ...
          >
            ...
            <option value="PAGAR">üì§ Contas a Pagar</option>
      ...
      {tipoVisualizacao === 'RECEBER' && (
        <div>
          <h2 className="text-2xl font-bold mb-4">üì• Contas a Receber ({contasReceberFiltradas.length})</h2>
      ...
      {tipoVisualizacao === 'PAGAR' && (
        <div>
          <h2 className="text-2xl font-bold mb-4">üì§ Contas a Pagar ({contasPagarFiltradas.length})</h2>
          <div className="bg-white rounded-lg shadow overflow-hidden">
            <div className="overflow-x-auto">
              <table className="min-w-full">
                <thead className="bg-gray-50">
