...
export default function ContaHubTestePage() {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const errorLogs = Array.isArray(data.logs)
          ? data.logs.filter((log: string) => log.includes('❌'))
          : [];
  ...
  return (
    <div className="space-y-6">
      ...
      {result && (
        <div className="mt-6 p-4 bg-gray-50 rounded-lg">
            ...
            <div className="mb-4">
              ...
              {result.resultados.sistema_raw && (
                <div className="mb-3 p-3 bg-blue-50 rounded">
                  ...
                  <div className="text-sm text-blue-600">
                    {result.resultados.sistema_raw.antes} →{' '}
                  ...
                  {Object.entries(result.resultados.tabelas_contahub).map(
                    ([tabela, info]: [string, TabelaInfo]) => (
                      ...
                      >
                        ...
                        >
                          {info.antes} → {info.depois} ({info.removidos}{' '}
                          removidos)
                          {info.erro && (
          ...
          {result.totais && (
            <div className="mb-4 p-4 bg-yellow-50 border border-yellow-200 rounded">
              <h3 className="font-semibold text-yellow-800 mb-2">
                📊 Resultados da Limpeza Completa
              </h3>
              ...
              {result.estrutura_tabela && (
                <div className="mb-4 p-3 bg-gray-50 rounded">
                  <div className="font-medium text-gray-800 mb-2">
                    🏗️ Estrutura da Tabela sistema_raw:
                  </div>
            ...
            <div className="mb-4">
              ...
              {result.analise.amostras_por_tipo &&
                Object.entries(result.analise.amostras_por_tipo).map(
                  (
                    [tipo, amostra]: [string, AmostraEstrutura],
                    index: number
                  ) => (
                    <div
                      key={index}
                    ...
                    >
                      <div className="mb-3 pb-2 border-b">
                        <h4 className="font-semibold text-gray-800">
                          Registro #{amostra.id} - {amostra.tipo_dados}
                        </h4>
                        <div className="text-sm text-gray-600">
                          Data: {amostra.data_referencia}
                        </div>
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-1">
                            {amostra.estrutura_json.keys_principais.map(
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                          <div
                            className={`p-2 rounded text-sm ${amostra.estrutura_json.tem_metadados ? 'bg-green-50 text-green-700' : 'bg-red-50 text-red-700'}`}
                          >
                            <div className="font-medium">Metadados</div>
                            <div>
                              {amostra.estrutura_json.tem_metadados
                                ? '✅ Sim'
                                : '❌ Não'}
                            </div>
                          </div>
                          <div
                            className={`p-2 rounded text-sm ${amostra.estrutura_json.tem_list ? 'bg-green-50 text-green-700' : 'bg-red-50 text-red-700'}`}
                          >
                            <div className="font-medium">
                              Campo &apos;list&apos;
                            </div>
                            <div>
                              {amostra.estrutura_json.tem_list
                                ? '✅ Sim'
                                : '❌ Não'}
                            </div>
                          </div>
                          <div
                            className={`p-2 rounded text-sm ${amostra.estrutura_json.list_e_array ? 'bg-green-50 text-green-700' : 'bg-yellow-50 text-yellow-700'}`}
                          >
                            <div className="font-medium">É Array</div>
                            <div>
                              {amostra.estrutura_json.list_e_array
                                ? '✅ Sim'
                                : '⚠️ ' + amostra.estrutura_json.tipo_list}
                            </div>
                          </div>
                          <div className="p-2 bg-blue-50 text-blue-700 rounded text-sm">
                            <div className="font-medium">Length</div>
                            <div>
                              {amostra.estrutura_json.length_list || '0'}
                            </div>
                          </div>
                        </div>
                        ...
                        {amostra.estrutura_json.metadados_info && (
                          <div className="p-3 bg-blue-50 rounded">
                            <div className="font-medium text-blue-800 mb-2">
                              🏷️ Informações dos Metadados:
                            </div>
                            <div className="text-sm text-blue-700">
                              <div>
                                Query ID:{' '}
                                {amostra.estrutura_json.metadados_info.query_id}
                              </div>
                              <div>
                                Query Nome:{' '}
                                {
                        ...
                        {amostra.estrutura_json.list_info && (
                          <div className="p-3 bg-green-50 rounded">
                            ...
                            <div className="text-sm text-green-700 space-y-1">
                              <div>
                                Tamanho:{' '}
                                {amostra.estrutura_json.list_info.length}{' '}
                                registros
                              </div>
                              ...
                              {amostra.estrutura_json.list_info
                                ...
                                <div>
                                  ...
                                  <div className="flex flex-wrap gap-1">
                                    {amostra.estrutura_json.list_info.primeiro_item_keys.map(
                                      (key: string, idx: number) => (
                                        <span
                                          key={idx}
                        ...
                        {amostra.estrutura_json.outros_arrays &&
                          amostra.estrutura_json.outros_arrays.length > 0 && (
                            <div className="p-3 bg-yellow-50 rounded">
                              <div className="font-medium text-yellow-800 mb-2">
                                📦 Outros Arrays Encontrados:
                              </div>
                              <div className="space-y-2">
                                {amostra.estrutura_json.outros_arrays.map(
                                  (
                                    arr: {
                                      campo: string;
                                      length: number;
                                    ...
                                    >
                                      <div className="font-medium">
                                        Campo: {arr.campo} ({arr.length} itens)
                                      </div>
                                      {arr.primeiro_item_keys && (
                                        <div className="flex flex-wrap gap-1 mt-1">
                                          {arr.primeiro_item_keys
                                            .slice(0, 10)
                                            .map(
                                              (key: string, keyIdx: number) => (
                                                <span
                                                  key={keyIdx}
                                                  className="bg-yellow-100 text-yellow-800 px-1 py-0.5 rounded text-xs"
                                                >
                                                  {key}
                                                </span>
                                              )
          ...
          {result.logs && result.logs.length > 0 && (
            <div className="mb-4">
              ...
              <div className="bg-red-50 border border-red-200 p-3 rounded text-sm">
                {result.logs
                  .filter((log: string) => log.includes('❌'))
          ...
          {debugData && (
            <div className="mb-4">
              <h3 className="font-semibold text-gray-800 mb-2">
                🔍 Análise de Discrepâncias dos Dados
              </h3>
                  ...
                  {debugData.clientes_cpf.analise?.cpfsExtras?.length > 0 && (
                    <div className="mb-4 p-3 bg-red-50 border border-red-200 rounded">
                      <h5 className="font-semibold text-red-800 mb-2">
                        ❌ CPFs Extras (não deveriam estar no banco):
                      </h5>
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                  ...
                  {debugData.clientes_cpf.analise?.cpfsFaltando?.length > 0 && (
                    <div className="mb-4 p-3 bg-orange-50 border border-orange-200 rounded">
                      <h5 className="font-semibold text-orange-800 mb-2">
                        ⚠️ CPFs Faltando (deveriam estar no banco):
                      </h5>
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                  ...
                  {debugData.clientes_cpf.duplicatas?.raw_ids_duplicados
                    ...
                    <div className="mb-4 p-3 bg-purple-50 border border-purple-200 rounded">
                      <h5 className="font-semibold text-purple-800 mb-2">
                        🔢 Raw IDs com Múltiplos Registros:
                      </h5>
                      <div className="space-y-1">
              ...
              {debugData.tempo && (
                <div className="p-4 border border-gray-200 rounded-lg">
                  ...
                  <div className="text-sm text-gray-600 mb-4">
                    📝 <strong>Política:</strong> Apenas registros com vd, itm e
                    prd válidos são inseridos. Dados incompletos são ignorados
                    (não geram erro).
                  </div>
      ...
      <PageCard>
        <div className="space-y-3">
          <PageText variant="subtitle">ℹ️ Informações do Teste</PageText>
          <div className="space-y-2">
            <PageText variant="body">
              • <strong>Período:</strong> 31/01/2025 até 04/02/2025 (5 dias)
            </PageText>
            <PageText variant="body">
              • <strong>Objetivo:</strong> Verificar mapeamento completo dos
              dados do ContaHub
            </PageText>
            <PageText variant="body">
              • <strong>Tabelas:</strong> contahub_analitico, contahub_periodo,
              contahub_fatporhora, etc.
            </PageText>
            <PageText variant="body">
              • <strong>Sistema:</strong> Coleta automatizada via API do
              ContaHub
            </PageText>
            <PageText variant="body">
              • <strong>🚀 Executar Teste:</strong> Coleta dados de 5 dias e
              salva na sistema_raw
            </PageText>
            <PageText variant="body">
              • <strong>⚙️ Processar Dados:</strong> Processa dados da
              sistema_raw para tabelas específicas
            </PageText>
            <PageText variant="body">
              • <strong>📊 Verificar Status:</strong> Mostra status das tabelas
              ContaHub
            </PageText>
            <PageText variant="body">
              • <strong>🔧 Debug Dados:</strong> Analisa a estrutura dos dados
              salvos na sistema_raw para entender campos disponíveis
            </PageText>
            <PageText variant="body">
              • <strong>🧹 Limpar Tudo:</strong> Remove TODOS os dados das
