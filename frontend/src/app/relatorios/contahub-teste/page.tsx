          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                ...
                <div className="mb-4">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    ...
                    <div className="bg-green-50 p-3 rounded">
                      ...
                      <div className="font-bold text-green-800">{result.estatisticas.sucessos || 0}</div>
                    </div>
                ...
                <div className="mb-4">
                  ...
                  {result.resultados.tabelas_contahub && (
                    <div className="space-y-2">
                      ...
                      {Object.entries(result.resultados.tabelas_contahub).map(([tabela, info]: [string, TabelaInfo]) => (
                ...
                <div className="mb-4">
                  ...
                  {result.estatisticas?.contagem_por_tipo && (
                    <div className="mb-4 p-3 bg-gray-50 rounded">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                        {Object.entries(result.estatisticas.contagem_por_tipo).map(([tipo, quantidade]: [string, number]) => (
                  ...
                  {result.ultimos_registros && result.ultimos_registros.length > 0 && (
                    <div className="mb-4">
                      ...
                      <div className="space-y-2">
                        {result.ultimos_registros.slice(0, 5).map((registro: RegistroProcessado, index: number) => (
              ...
              {result.analise && (
                <div className="mb-4">
                  ...
                  {result.analise.amostras_por_tipo && Object.entries(result.analise.amostras_por_tipo).map(([tipo, amostra]: [string, AmostraEstrutura], index: number) => (
...
{JSON.stringify(amostra.estrutura_json.list_info.primeiro_item_sample, null, 2)}
                        ...
                        {amostra.estrutura_json.outros_arrays && amostra.estrutura_json.outros_arrays.length > 0 && (
                          <div className="p-3 bg-yellow-50 rounded">
                            ...
                            <div className="space-y-2">
                              {amostra.estrutura_json.outros_arrays.map((arr: { campo: string; length: number; primeiro_item_keys?: string[] }, idx: number) => (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {result.status.sistema_raw && (
                      <div className="bg-blue-50 p-3 rounded">
                        ...
                        <div className="text-sm text-blue-600">
                          {typeof result.status.sistema_raw === 'object' && (result.status.sistema_raw as SistemaRawStatus).existe ? 
                    ...
                    {/* Tabelas ContaHub */}
                    {(result.status as StatusResult).tabelas_contahub && Object.entries((result.status as StatusResult).tabelas_contahub).map(([tabela, info]: [string, TabelaContaHubInfo]) => (
              ...
              {result.resultados && Object.entries(result.resultados || {}).some(([tabela, info]: [string, TabelaInfo]) => info.campos_existentes) && (
                <div className="mb-4">
                  ...
                  {/* Detalhes por tabela */}
                  <div className="space-y-3">
                    {Object.entries(result.resultados || {}).map(([tabela, info]: [string, TabelaInfo]) => (
                    ...
                    {result.analises.map((analise: Analise, index: number) => (
                      <div key={analise.id} className="p-4 border border-gray-200 rounded-lg">
                        <div className="flex justify-between items-start mb-3">
                          <div>
                            <h4 className="font-mono font-semibold text-gray-800">{analise.titulo}</h4>
                            <div className="text-sm text-gray-600">
