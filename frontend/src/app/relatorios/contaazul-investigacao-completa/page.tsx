...
export default function ContaAzulInvestigacaoCompleta() {
  ...
  const executarInvestigacao = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.error || 'Erro na investiga·ß·£o');
      }
  ...
  const executarInvestigacaoEspecifica = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.error || 'Erro na investiga·ß·£o de categorias');
      }
    ...
    <div className="container mx-auto py-8 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold mb-2">üîç Investiga·ß·£o Completa ContaAzul</h1>
          <p className="text-gray-600">
            Testando TODOS os endpoints poss·≠veis para encontrar dados de categoriza·ß·£o
          </p>
        </div>
          ...
          >
            {loading ? (
              <>
                ...
                Investigando... (pode demorar at·© 30 segundos)
              </>
            ) : (
              <>
          ...
          >
            {loading ? (
              ...
              <>
                ...
                üéØ Investigar Categorias Espec·≠ficas
              </>
            )}
          </Button>
        </div>
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="mt-6">
                  <h3 className="font-semibold mb-3">üéØ Endpoints com Sucesso</h3>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  An·°lise completa de cada evento testado
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>üìù JSON Completo</CardTitle>
                <CardDescription>
                  Dados completos da investiga·ß·£o para an·°lise t·©cnica
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Textarea
