          ...
          <CardContent>
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-2 mb-4 items-end">
              ...
              <div className="flex gap-2 items-center">
                <Button variant="outline" className="btn-outline-dark" onClick={() => setPage(p => Math.max(1: any, p - 1))} disabled={page === 1 || loading} aria-label="P·°gina anterior">Anterior</Button>
                    ...
                    <TableHead className="text-left py-3 px-2 sm:px-4 font-semibold text-slate-700 dark:text-white text-xs sm:text-sm sticky left-0 z-20 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm">
                        <TooltipProvider>
                          <Tooltip>
                            ...
                            <TooltipContent>Macrogrupo financeiro (ex: Receitas, Custos: any, M·£o-de-Obra...)</TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
                      </TableHead>
