...
const CATEGORIA_ICONS: Record<string, any> = {
  'Stone Crá©dito': <DollarSign className="w-4 h-4 text-blue-500 dark:text-blue-300" />,
  'Stone Dá©bito': <DollarSign className="w-4 h-4 text-blue-400 dark:text-blue-200" />,
...
const MAP_META_TO_CATEGORIA = {
  'Faturamento Total': 'Stone Crá©dito', // Exemplo, ajustar conforme real
  // ...adicionar outros se necessá¡rio
};

// 2. Spinner para exportaá§á£o
function Spinner() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg max-w-lg w-full p-6 relative">
        <button className="absolute top-2 right-2 text-gray-500 dark:text-gray-300" onClick={onClose} aria-label="Fechar">œ•</button>
        <h2 className="card-title-dark mb-2">Detalhes: {categoria} ({grupo})</h2>
        <div className="max-h-80 overflow-y-auto">
          <table className="w-full text-xs">
            <thead>
              <tr>
                <th className="text-left">Descriá§á£o</th>
      ...
      <div className="container mx-auto px-2 sm:px-4 py-4 flex-1 flex flex-col">
        <Card className="card-dark w-full max-w-5xl mx-auto shadow-lg border border-gray-200 dark:border-gray-700">
          <CardHeader>
            ...
            <div className="card-description-dark mt-1">Acompanhe o desempenho financeiro do bar, agrupado por categoria, com visual premium e filtros rá¡pidos.</div>
            <div className="flex flex-col sm:flex-row flex-wrap gap-2 mt-4 items-center">
              {/* Multi-select de máªs/ano */}
              <select
          ...
          <CardContent>
            ...
            <div className="overflow-x-auto rounded-lg shadow-inner">
              <Table className="table-dark w-full text-xs sm:text-sm min-w-[600px]">
                <TableHeader>
                  <TableRow className={`border-b border-slate-200 dark:border-gray-700 ${!isMobile ? 'sticky top-0 z-10 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm' : ''}`}> {/* sticky sá³ desktop */}
                      ...
                      <TableHead className="text-left py-3 px-2 sm:px-4 font-semibold text-slate-700 dark:text-white text-xs sm:text-sm">
                        <TooltipProvider>
                          <Tooltip>
                            ...
                            <TooltipContent>Categoria detalhada do laná§amento financeiro</TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
                      </TableHead>
                      <TableHead className="text-right py-3 px-2 sm:px-4 font-semibold text-slate-700 dark:text-white text-xs sm:text-sm">
                        <TooltipProvider>
                          <Tooltip>
                            ...
                            <TooltipContent>Valor consolidado da categoria no perá­odo</TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
                      </TableHead>
                      <TableHead className="text-right py-3 px-2 sm:px-4 font-semibold text-slate-700 dark:text-white text-xs sm:text-sm">
                        ...
                        <TooltipProvider>
                          <Tooltip>
                            ...
                            <TooltipContent>Meta definida para o indicador (configurada em Configuraá§áµes &gt; Metas)</TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
                      </TableHead>
                      <TableHead className="text-right py-3 px-2 sm:px-4 font-semibold text-slate-700 dark:text-white text-xs sm:text-sm">
                        <TooltipProvider>
                          <Tooltip>
                            ...
                            <TooltipContent>Percentual do valor em relaá§á£o ao total geral</TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
                      </TableHead>
                    </TableRow>
                                    ...
                                    {meta ? (
                                      <TooltipProvider>
                                        <Tooltip>
                                          ...
                                          <TooltipContent>Meta definida em <b>Configuraá§áµes &gt; Metas</b>. Altere lá¡ para ajustar este valor.</TooltipContent>
                                        </Tooltip>
                                      </TooltipProvider>
                    ...
                    <TableRow>
                      <TableCell colSpan={5} className="py-12 text-center text-gray-500 dark:text-gray-400">
                        <div className="flex flex-col items-center gap-2">
                          ...
                          <p>Nenhum dado encontrado para o perá­odo selecionado.</p>
                          <p className="text-xs mt-2">Tente ajustar os filtros de perá­odo ou máªs/ano para visualizar dados.</p>
                        </div>
                      </TableCell>
                    </TableRow>
                  )}
          ...
          <div className="flex flex-wrap gap-4 mt-4 items-center text-xs">
            ...
            <span className="inline-flex items-center gap-1 px-2 py-1 rounded text-xs font-medium bg-red-100 dark:bg-red-900/40 text-red-700 dark:text-red-300"><Award className="w-4 h-4 text-red-500 dark:text-red-300" />Meta ná£o atingida</span>
