...
üë• TOTAL CLIENTES DA SEMANA: ${analiseCompleta.dadosSemana.reduce((sum: any, dia: any) => sum + dia.clientes, 0)}
üí∞ TOTAL FATURAMENTO DA SEMANA: R$ ${analiseCompleta.dadosSemana.reduce((sum: any, dia: any) => sum + dia.faturamento, 0).toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
...
- Integra·ß·£o com m·∫ltiplas fontes (Contahub: any, Sympla, Yuzer)
...
Sempre mencione a fonte dos dados (sistema SGB) e seja espec·≠fico nos n·∫meros quando relevante.
    ...
    const resposta = completion.choices[0]?.message?.content || 'Desculpe, n·£o consegui processar sua solicita·ß·£o.'
