...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('üèÜ TOP POR VISITAS (primeiros 3):', topPorVisitas.slice(0, 3).map((c) => ({
      nome: c.nome,
      telefone: c.telefone,
    ...
    console.log('üí∞ TOP POR TICKET M·âDIO (primeiros 3):', topPorTicket.slice(0, 3).map((c) => ({
      nome: c.nome,
      telefone: c.telefone,
      total_visitas: c.total_visitas,
      ticket_medio: c.ticket_medio,
    ...
    console.log('üíé TOP POR FATURAMENTO (primeiros 3):', topPorReceita.slice(0, 3).map((c) => ({
      nome: c.nome,
      telefone: c.telefone,
      total_visitas: c.total_visitas,
      ticket_medio: c.ticket_medio,
