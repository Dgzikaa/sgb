  ...
  try {
    ...
    for (const [telefoneNormalizado, dadosTelefone] of telefoneMap.entries()) {
      ...
      const visitasUnicas = visitasCliente
        ...
        .slice(0, 100); // M·°ximo de 100 visitas por telefone
    ...
    console.log('üèÜ TOP POR VISITAS (primeiros 3):', topPorVisitas.slice(0, 3).map((c: any) => ({
      nome: c.nome,
      telefone: c.telefone,
    ...
    console.log('üí∞ TOP POR TICKET M·âDIO (primeiros 3):', topPorTicket.slice(0, 3).map((c: any) => ({
      nome: c.nome,
      telefone: c.telefone,
      total_visitas: c.total_visitas,
      ticket_medio: c.ticket_medio,
    ...
    console.log('üíé TOP POR FATURAMENTO (primeiros 3):', topPorReceita.slice(0, 3).map((c: any) => ({
      nome: c.nome,
      telefone: c.telefone,
      total_visitas: c.total_visitas,
      ticket_medio: c.ticket_medio,
