...
export async function GET(request: NextRequest) {
  try {
    console.log('è∞ CRON JOB: Coleta di·°ria ContaHub iniciada')
    
    // Verificar se ·© um cron autorizado (opcional - adicionar header de seguran·ßa)
    ...
    console.log(`üì° Executando edge function: ${edgeFunctionUrl}`)
