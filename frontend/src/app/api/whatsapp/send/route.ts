  ...
  try {
    ...
    if (!numbers || numbers.length === 0) {
      return NextResponse.json(
        { error: 'Náºmeros de telefone sá£o obrigatá³rios' },
        { status: 400 }
      )
    }
...
// Funá§á£o auxiliar para enviar para Evolution API
async function sendToEvolutionAPI(messageData: WhatsAppMessage) {
  // ðŸ§ª MODO SIMULAá‡áƒO - Para testes sem WhatsApp real
  ...
  // ðŸ“± MODO PRODUá‡áƒO - Envio real para Evolution API
...
// Funá§á£o para formatar mensagem de checklist
