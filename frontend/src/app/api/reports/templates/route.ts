...
// =====================================================
// GET - LISTAR TEMPLATES DE RELAT·ìRIOS
// =====================================================
export async function GET(request: NextRequest) {
  try {
    ...
    // Buscar templates com pagina·ß·£o
...
// =====================================================
// POST - CRIAR TEMPLATE DE RELAT·ìRIO
// =====================================================
export async function POST(request: NextRequest) {
  try {
    ...
    // Verificar permiss·µes (apenas admin e financeiro podem criar templates)
    ...
    console.log(`üìä Template de relat·≥rio criado: ${data.nome} (${data.categoria})`)
...
async function validarSqlTemplate(sql: string): Promise<{ valido: boolean, erro?: string }> {
  try {
    ...
    // Deve referenciar $bar_id para seguran·ßa multi-tenant
    if (!sql.includes('$bar_id')) {
      return { valido: false, erro: 'SQL deve incluir filtro por $bar_id para seguran·ßa' }
    }

    return { valido: true }

  } catch (error) {
    return { valido: false, erro: 'Erro na valida·ß·£o do SQL' }
  }
} 
