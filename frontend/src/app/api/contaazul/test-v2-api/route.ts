...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('üß™ TESTANDO API v2 DO CONTAAZUL (igual sync-dados-brutos)...')
    ...
    // 2. Verificar token (igual sync-dados-brutos - SEM renova·ß·£o autom·°tica)
    ...
    console.log('üß™ TESTE 1: Categorias v2...')
    try {
    ...
    // TESTE 2: Receitas v2
    console.log('üß™ TESTE 2: Receitas v2...')
    try {
    ...
    // TESTE 3: Despesas v2
    console.log('üß™ TESTE 3: Despesas v2...')
    try {
