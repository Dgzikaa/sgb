...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('üîç TESTANDO ENDPOINTS B·ÅSICOS DO CONTAAZUL...')

    // úÖ USAR HELPER QUE RENOVA AUTOMATICAMENTE (igual sync-dados-brutos)
    ...
    if (!accessToken) {
      return NextResponse.json({ 
        ...
        details: 'Renova·ß·£o autom·°tica falhou'
      }, { status: 401 })
    }
    ...
    console.log('üß™ TESTE 1: Endpoint receitas b·°sico...')
    try {
    ...
    console.log('üß™ TESTE 2: Endpoint despesas b·°sico...')
    try {
    ...
    console.log('üß™ TESTE 3: Endpoint categorias...')
    try {
    ...
    // TESTE 4: Endpoint novo com compet·™ncia (exato da documenta·ß·£o)
    console.log('üß™ TESTE 4: Endpoint com compet·™ncia...')
    try {
    ...
    console.log('üß™ TESTE 5: Endpoint eventos financeiros...')
    try {
