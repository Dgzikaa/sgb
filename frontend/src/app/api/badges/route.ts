...
export async function POST(request: NextRequest) {
  try {
    ...
    // Ã°Å¸Å½Â¯ BUSCAR TODOS OS DADOS EM UMA SÃ¡â€œ CONSULTA
    const badges = {
      // Principais
      checklist: 0,
      producao: 0, 
    ...
    try {
      ...
      // 2. PRODUÃ¡â€¡Ã¡â€¢ES PENDENTES (todos os tipos)
      ...
      // 3. NOTIFICAÃ¡â€¡Ã¡â€¢ES NÃ¡Æ’O LIDAS
      ...
      // 4. ALERTAS DO SISTEMA (visÃ¡Â£o geral)
      ...
      // 7. CONFIGURAÃ¡â€¡Ã¡â€¢ES - Para admins apenas
      if (user.role === 'admin') {
