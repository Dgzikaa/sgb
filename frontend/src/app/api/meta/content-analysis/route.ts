...
export async function GET(request: NextRequest) {
  try {
    console.log('üì± An·°lise AVAN·áADA de conte·∫do Meta...')
    ...
    try {
      ...
      // 1. AN·ÅLISE DE POSTS DO INSTAGRAM
      if (instagramId) {
        console.log('üì∑ Analisando posts do Instagram...')
        ...
        try {
          console.log('üìñ Analisando Instagram Stories...')
          ...
          console.warn('ö†Ô∏è Erro ao buscar stories:', storiesError)
        }
      }

      // 3. AN·ÅLISE DE POSTS DO FACEBOOK
      if (pageId) {
        console.log('üìò Analisando posts do Facebook...')
      ...
      // 4. RECOMENDA·á·ïES BASEADAS EM IA
      ...
      console.log(`ö†Ô∏è Erro ao analisar conte·∫do: ${metaError.message}`)
