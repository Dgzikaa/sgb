...
export async function GET(request: NextRequest) {
  try {
    console.log('è∞ Otimiza·ß·£o Temporal - Analisando padr·µes temporais...')
    ...
    if (userData) {
      try {
        ...
        console.log(`üë§ Otimiza·ß·£o Temporal - Usando bar_id: ${barId}`)
      } catch (e) {
    ...
    console.log('è∞ Otimiza·ß·£o Temporal - Analisando para bar:', barId: any, 'plataforma:', plataforma)

    // 1. COLETAR DADOS HIST·ìRICOS - CORRIGIR NOMES DAS TABELAS
    ...
    // 3. GERAR RECOMENDA·á·ïES INTELIGENTES
    ...
    console.log('úÖ Otimiza·ß·£o Temporal processada:', {
      plataforma: plataforma,
    ...
    console.error('ùå Erro na Otimiza·ß·£o Temporal:', error)
    return NextResponse.json({ 
      success: false, 
