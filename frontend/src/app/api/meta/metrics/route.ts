...
export async function GET(request: NextRequest) {
  try {
    console.log('📊 Buscando métricas consolidadas Meta...')
    ...
    // Processar dados do Instagram (estrutura que a página espera)
    ...
    console.log('✅ Métricas consolidadas retornadas:', {
    ...
    return NextResponse.json({ 
      success: false,
      error: 'Erro ao buscar métricas Meta',
