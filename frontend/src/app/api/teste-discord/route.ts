...
export async function GET(request: NextRequest) {
  try {
    const webhookUrl =
      'https://discord.com/api/webhooks/1397957282771239004/PtuGxuTrNDIPRx_tliv1es5zg3zv-TkdvWel4Git_QHOi9X7T-BP1k25lRl6364PqeHT';

    const embed = {
      title: '🧪 Teste de Webhook Discord',
      color: 0x00ff00, // Verde
      description:
        'Este é um teste para verificar se o webhook está funcionando',
      fields: [
        {
          name: 'Status',
