...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('Ã°Å¸â€â€ž Iniciando importaÃ¡Â§Ã¡Â£o da CSV...');
    ...
    console.log(`Ã°Å¸â€œÂ CSV encontrada com ${lines.length} linhas`);
    ...
    // Pular o cabeÃ¡Â§alho (primeira linha)
    ...
    console.log(`Ã°Å¸â€œÂ Processados ${eventosParaInserir.length} eventos da CSV`);
