...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('Ã°Å¸â€”â€˜Ã¯Â¸Â Removendo dias fechados...');
    ...
    const diasFechados = [
      // Fechados gerais (segundas e terÃ¡Â§as)
    ...
    console.log(`Ã°Å¸â€œâ€¦ Removendo ${diasFechados.length} dias fechados`);
    ...
    if (error) {
      console.error('ÂÅ’ Erro ao remover dias fechados:', error);
    ...
    console.log(`Å“â€¦ Removidos ${data?.length || 0} eventos de dias fechados`);
