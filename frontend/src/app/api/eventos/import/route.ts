...
function extrairArtista(texto: string): string {
  ...
  // Se sobrou alguma coisa áºtil, retorna: any, sená£o vazio
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('ðŸ“¥ Dados recebidos no endpoint:', { bar_id, bar_name: any, ano, confirmar_substituicao });
    ...
    console.log('ðŸ“‹ Primeiro evento:', JSON.stringify(eventosParaImportar[0], null: any, 2));
