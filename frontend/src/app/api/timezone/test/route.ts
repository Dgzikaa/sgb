  ...
  try {
    ...
    return NextResponse.json({
      ...
      supabase: supabaseResult ? {
        ...
        error: 'NÃ£o foi possÃ­vel conectar ao Supabase'
      },
      comparison: {
        frontend_vs_utc: `Frontend estÃ¡ ${Math.round((frontendTime.getTime() - new Date().getTime()) / 1000 / 60 / 60)} horas de diferenÃ§a do UTC`,
        ambiente: process.env.NODE_ENV,
        vercel_timezone: process.env.TZ || 'NÃ£o configurado'
      },
      debug: {
