  ...
  const loadPostHighlights = async () => {
    ...
    try {
      ...
      if (json.success && json.management_data) {
        ...
        // Ordenar por engagement_rate (desc), likes, impressões
        allPosts.sort((a, b) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="container mx-auto px-6 py-8 max-w-7xl">
        {/* Substituir todas as TabsList/Tabs secundárias por uma única Tabs principal no topo: */}
        <Tabs value={selectedTab} onValueChange={setSelectedTab} className="space-y-6 mb-6">
          ...
          {/* Tab Destaques: só cards de resumo premium */}
          <TabsContent value="destaques" className="space-y-6">
            <div className="rounded-2xl mb-6 p-6 bg-gradient-to-r from-purple-700 via-blue-700 to-blue-900 shadow-lg flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                ...
                <p className="text-base text-white/80">Visão completa da performance em redes sociais e campanhas</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
              ...
              <Card className="card-dark bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg">
                <CardContent className="p-6">
                  ...
                  <p className="card-description-dark">Gasto total (mês)</p>
          ...
          {/* Tab Visão Geral: KPIs principais, gráficos, cards, etc */}
            ...
            <Card className="card-dark bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg">
              ...
              <CardContent className="p-0">
                  ...
                  <table className="table-dark w-full">
                    <thead className="table-header-dark">
                      <tr>
                        ...
                        <th className="py-4 px-6 cursor-pointer" onClick={() => { setCampaignsTableSort('impressions'); setCampaignsTableOrder(campaignsTableOrder === 'asc' ? 'desc' : 'asc'); }}>Impressões</th>
                ...
                <div className="flex justify-between items-center p-4">
                  <span className="text-xs card-description-dark">Página {campaignsTablePage} de {Math.ceil(campaignsTableTotal/campaignsTablePageSize) || 1}</span>
                  <div className="flex gap-2">
                    ...
                    <Button className="btn-secondary-dark px-3 py-1" disabled={campaignsTablePage*campaignsTablePageSize>=campaignsTableTotal} onClick={()=>setCampaignsTablePage(p=>p+1)}>Próxima</Button>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            {advancedLoading ? (
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-between p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border-l-4 border-blue-500">
                      <div>
                        ...
                        <div className="card-description-dark">Impressões</div>
                      </div>
                    ...
                    <div className="flex items-center justify-between p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border-l-4 border-blue-500">
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-xs text-blue-500">Taxa de conversão</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border-l-4 border-green-500">
                      <div>
                        ...
                        <div className="card-description-dark">Conversões</div>
                      </div>
                      <div className="text-right">
              ...
              <Card className="bg-white dark:bg-gray-800 shadow-lg border-0">
                <CardContent className="p-12 text-center">
                  ...
                  {/* Botão removido, agora carrega automático */}
                </CardContent>
              </Card>
            )}
          </TabsContent>

          {/* Tab Otimização (unificada) */}
          <TabsContent value="optimization" className="space-y-6">
            {/* Juntar conteúdo de Radar, Temporal e Journey aqui */}
            {advancedLoading ? (
              <Card className="bg-white dark:bg-gray-800 shadow-lg border-0">
                <CardContent className="p-12 text-center">
                  <Loader2 className="w-8 h-8 animate-spin text-blue-600 mx-auto mb-4" />
                  ...
                  <CardContent className="p-6">
                    <div className="space-y-4">
                      <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                        <div className="font-semibold text-blue-800 dark:text-blue-200">🕘 Melhor Horário</div>
                        <div className="text-lg font-bold text-blue-900 dark:text-blue-100">{advancedData.radar_oportunidades.melhor_horario}</div>
                        <div className="text-sm text-blue-700 dark:text-blue-300">Para máximo engajamento</div>
                      </div>
                      <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                        <div className="font-semibold text-purple-800 dark:text-purple-200">📅 Dias Ótimos</div>
