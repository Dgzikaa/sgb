    ...
    try {
      ...
      if (metricaSelecionada === 'faturamento') {
        ...
        try {
          ...
          console.log('üí∞ Amostra valores:', dados.slice(0, 5).map((d: any) => ({ 
            data: d.data, 
        ...
        try {
          ...
          console.log('üìÖ Per·≠odo:', dados[0]?.data, 'at·©', dados[dados.length - 1]?.data)
          console.log('üë• Amostra valores:', dados.slice(0, 5).map((d: any) => ({ 
            data: d.data, 
        ...
        try {
          ...
          try {
            ...
            if (!error && data) {
              ...
              console.log('üìÖ Per·≠odo:', dados[0]?.data, 'at·©', dados[dados.length - 1]?.data)
              console.log('üéØ Amostra valores:', dados.slice(0, 5).map((d: any) => ({ 
                data: d.data, 
            ...
            if (allFaturamentoData.length > 0 && clientesData && clientesData.length > 0) {
              ...
              console.log('üìÖ Per·≠odo:', dados[0]?.data, 'at·©', dados[dados.length - 1]?.data)
              console.log('üìä Amostra valores:', dados.slice(0, 5).map((d: any) => ({ 
                data: d.data, 
