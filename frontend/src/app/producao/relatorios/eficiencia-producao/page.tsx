  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <Card className="bg-gradient-to-r from-blue-600 to-purple-600 text-white">
          <CardHeader>
            <CardTitle className="text-2xl flex items-center gap-3">
              ...
              Relat·≥rio de Efici·™ncia de Produ·ß·£o
              {selectedBar && (
            ...
            <div className="flex items-center gap-3">
              <label className="flex items-center gap-2 text-black font-medium">
                <input
                  ...
                  className="rounded"
                />
                Mostrar apenas problemas (efici·™ncia &lt; 90%, varia·ß·£o custo &gt; R$ 1,00, perda &gt; 25%)
              </label>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
          <Card>
            <CardContent className="p-4 text-center">
              ...
              <div className="text-sm text-black font-medium">Produ·ß·µes</div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-4 text-center">
          ...
          <Card>
            <CardContent className="p-4 text-center">
              ...
              <div className="text-sm text-black font-medium">Varia·ß·£o Custo</div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-4 text-center">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-black">Produ·ß·µes Detalhadas</CardTitle>
          </CardHeader>
          <CardContent>
            {loading ? (
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
                        ...
                        <div className="text-center">
                          ...
                          <div className="text-sm space-y-1">
                            ...
                            <div className="flex justify-between">
                              <span className="text-black">Produ·ß·£o:</span>
                        ...
                        <div className="text-center">
                          ...
                          <div className="text-sm space-y-1">
                            ...
                            <div className="flex justify-between">
                              <span className="text-black">Varia·ß·£o:</span>
                      ...
                      <div className="mt-3 flex flex-wrap gap-2">
                        {producao.eficiencia_quantidade < 90 && (
                          <Badge variant="destructive" className="text-xs">
                            ö†Ô∏è Baixa efici·™ncia quantidade
                          </Badge>
                        )}
                        {Math.abs(producao.variacao_custo) > 2 && (
                          <Badge variant="destructive" className="text-xs">
                            üí∞ Alta varia·ß·£o custo
                          </Badge>
                        )}
                        {(producao.perda_total_g / producao.peso_bruto_g) > 0.25 && (
                          <Badge variant="destructive" className="text-xs">
                            öñÔ∏è Perda excessiva ({((producao.perda_total_g / producao.peso_bruto_g) * 100).toFixed(0)}%)
                          </Badge>
                        )}
                        {producao.rendimento_real < (producao.rendimento_teorico - 10) && (
                          <Badge variant="secondary" className="text-xs">
                            üìâ Rendimento abaixo do esperado
                          </Badge>
                        )}
                      </div>
                    </CardContent>
