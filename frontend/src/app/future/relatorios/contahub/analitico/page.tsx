  ...
  return (
    <ProtectedRoute requiredModule="relatorios">
      <div className="space-y-6 mt-8">
        ...
        {/* Tabela de Dados - DataTablePro v2 */}
        <Card className="card-dark shadow-sm">
          <CardHeader>
            <CardTitle className="text-gray-900 dark:text-white">Dados Analíticos</CardTitle>
            <CardDescription>
          ...
          <CardContent>
            {loading ? (
              ...
              <DataTablePro
                ...
                selectableRows
                columns={[
                  { key: 'vd_localizacao', header: 'Localização', sortable: true },
                  { key: 'prd_desc', header: 'Produto', sortable: true },
                  { key: 'qtd', header: 'Qtd', align: 'right', sortable: true },
                  { key: 'valorfinal', header: 'Valor Final', align: 'right', sortable: true, render: (r: AnaliticoData) => `R$ ${Number(r.valorfinal||0).toLocaleString('pt-BR', { minimumFractionDigits: 2 })}` },
                  { key: 'desconto', header: 'Desconto', align: 'right', sortable: true, render: (r: AnaliticoData) => `R$ ${Number(r.desconto||0).toLocaleString('pt-BR', { minimumFractionDigits: 2 })}` },
                  { key: 'mesano', header: 'Mês/Ano', render: (r: AnaliticoData) => `${r.mes}/${r.ano}` },
                ]}
              />
            )}
          </CardContent>
