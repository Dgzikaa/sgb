              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Esta integração está sendo desenvolvida e estará disponível
                    em breve.
                  </p>
                </div>
              </div>
          ...
          <CardContent>
            <div className="space-y-4 text-gray-600 dark:text-gray-400">
              <p className="text-base leading-relaxed">
                Windsor.AI é uma plataforma de analytics avançado que combina
                inteligência artificial com análise de dados para fornecer
                insights preditivos e automatizados. A integração permitirá que
                o SGB aproveite recursos de IA para otimizar operações e
