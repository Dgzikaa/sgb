...
export default function RedefinirSenhaPage() {
  ...
  const validarSenha = () => {
    if (!novaSenha) {
      setErro('Nova senha Ã¡Â© obrigatÃ¡Â³ria')
      return false
    }
    ...
    if (novaSenha !== confirmarSenha) {
      setErro('As senhas nÃ¡Â£o coincidem')
      return false
    }
    setErro('')
    return true
  ...
  const redefinirSenha = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErro('Erro de conexÃ¡Â£o. Tente novamente.')
    } finally {
      setCarregando(false)
    }
  }
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md text-center">
          ...
          <p className="text-gray-600 mb-4">
            Sua senha foi atualizada com sucesso. VocÃ¡Âª serÃ¡Â¡ redirecionado para a pÃ¡Â¡gina de login.
          </p>
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Como Ã¡Â© seu primeiro acesso, vocÃ¡Âª precisa criar uma nova senha para sua conta.
          </p>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-xs text-gray-500">
            ApÃ¡Â³s redefinir, vocÃ¡Âª serÃ¡Â¡ redirecionado para fazer login com sua nova senha.
          </p>
        </div>
      </div>
    </div>
