...
const categoriasPadrao: CategoriaEvento[] = [
  { id: 'show', nome: 'Show/MÃ¡Âºsica', cor: 'bg-purple-500', icon: 'Ã°Å¸Å½Âµ' },
  { id: 'festa', nome: 'Festa TemÃ¡Â¡tica', cor: 'bg-pink-500', icon: 'Ã°Å¸Å½â€°' },
  { id: 'happy-hour', nome: 'Happy Hour', cor: 'bg-orange-500', icon: 'Ã°Å¸ÂÂ»' },
  { id: 'esporte', nome: 'Evento Esportivo', cor: 'bg-green-500', icon: 'Å¡Â½' },
  { id: 'gastronomia', nome: 'Gastronomia', cor: 'bg-yellow-500', icon: 'Ã°Å¸ÂÂ½Ã¯Â¸Â' },
  { id: 'networking', nome: 'Networking', cor: 'bg-blue-500', icon: 'Ã°Å¸Â¤Â' },
  { id: 'promocao', nome: 'PromoÃ¡Â§Ã¡Â£o', cor: 'bg-red-500', icon: 'Ã°Å¸ÂÂ·Ã¯Â¸Â' },
  { id: 'especial', nome: 'Data Especial', cor: 'bg-indigo-500', icon: 'Ã°Å¸Å’Å¸' }
]
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input
                      placeholder="Nome, descriÃ¡Â§Ã¡Â£o..."
                      value={searchTerm}
                ...
                <div>
                  ...
                  <Select value={filtroStatus} onValueChange={setFiltroStatus}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="concluido">ConcluÃ¡Â­do</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <Card>
              <CardContent className="p-4 text-center">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Total do MÃ¡Âªs</p>
              </CardContent>
            </Card>
...
// Componente do formulÃ¡Â¡rio de evento
function EventForm({ 
  evento, 
  onSave, 
  onCancel, 
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="md:col-span-2">
          <Label htmlFor="descricao">DescriÃ¡Â§Ã¡Â£o</Label>
          <Textarea
            id="descricao"
        ...
        <div>
          <Label htmlFor="hora_inicio">Hora de InÃ¡Â­cio</Label>
          <Input
            id="hora_inicio"
            type="time"
        ...
        <div>
          ...
          <Input
            ...
            placeholder="Ex: SalÃ¡Â£o Principal..."
          />
        </div>
      </div>
...
function CalendarView({ 
  ...
  return (
    <div className="grid grid-cols-7 gap-1">
      {/* CabeÃ¡Â§alho dos dias da semana */}
      {['Dom', 'Seg', 'Ter', 'Qua', 'Qui', 'Sex', 'SÃ¡Â¡b'].map((day) => (
