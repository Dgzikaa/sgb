...
export default function DashboardFinanceiroPage() {
  ...
  const fixCategoryName = (categoryName: string) => {
    ...
    return categoryName
      ...
      .replace(/Produ·Éß·É£o/g, 'Produ·ß·£o')
      .replace(/Opera·Éß·É£o/g, 'Opera·ß·£o')
      .replace(/Programa·Éß·É£o/g, 'Programa·ß·£o')
      .replace(/Atra·Éß·Éµes/g, 'Atra·ß·µes')
  }
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="resumo" className="space-y-6">
              ...
              {data && (
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                  ...
                  <Card className="shadow-lg border-0 bg-gradient-to-br from-blue-50 to-white hover:shadow-xl transition-all duration-300">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                      <CardTitle className="text-sm font-semibold text-gray-700">Total Transa·ß·µes</CardTitle>
                  ...
                  <Card className="shadow-lg border-0 bg-gradient-to-br from-white to-green-50/30">
                    <CardHeader className="pb-3">
                      <CardTitle className="flex items-center gap-2">
                        ...
                        <span className="text-gray-800 font-bold">Distribui·ß·£o de Receitas</span>
                      </CardTitle>
                  ...
                  <Card className="shadow-lg border-0 bg-gradient-to-br from-white to-blue-50/30">
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        ...
                        <div className="flex justify-between items-center">
                          <span className="text-sm font-medium text-gray-700">Receita por Transa·ß·£o</span>
                        ...
                        <div className="flex justify-between items-center">
                          <span className="text-sm font-medium text-gray-700">Despesa por Transa·ß·£o</span>
                        ...
                        <div className="flex justify-between items-center">
                          <span className="text-sm font-medium text-gray-700">Taxa de Categoriza·ß·£o</span>
                  ...
                  <Card className="shadow-lg border-0 bg-gradient-to-br from-white to-teal-50/30">
                    <CardHeader className="pb-3">
                      <CardTitle className="flex items-center gap-2">
                        ...
                        <span className="text-gray-800 font-bold">Diversifica·ß·£o</span>
                      </CardTitle>
                      <CardDescription className="text-gray-600 font-medium">
                      ...
                      <div className="space-y-4">
                        {(() => {
                          ...
                          return (
                            <>
                              <div className="flex justify-between items-center">
                                <span className="text-sm font-medium text-gray-700">Concentra·ß·£o Principal</span>
                              ...
                              <div className="flex justify-between items-center">
                                <span className="text-sm font-medium text-gray-700">Risco de Concentra·ß·£o</span>
                                <span className={`text-sm font-bold ${corRisco}`}>
                                  {risco}
                                </span>
                              </div>
                              ...
                              <div className={`p-3 rounded-lg ${concentracao > 50 ? 'bg-red-50' : concentracao > 30 ? 'bg-yellow-50' : 'bg-green-50'}`}>
                                <div className={`text-xs font-medium ${concentracao > 50 ? 'text-red-700' : concentracao > 30 ? 'text-yellow-700' : 'text-green-700'}`}>
                                  {concentracao > 50 ? 'ö†Ô∏è Alta depend·™ncia de uma fonte' : 
                                   concentracao > 30 ? 'ö° Concentra·ß·£o moderada' : 
                  ...
                  <CardContent className="py-8">
                    <div className="text-center">
                      ...
                      <p className="text-gray-500 mb-4">
                        Clique em "Atualizar Dados" para carregar as informa·ß·µes financeiras do ContaAzul.
                      </p>
              ...
              {!loading && !selectedBar && (
                <Alert>
                  <AlertDescription>
                    üí° Selecione um bar no menu lateral para visualizar os dados financeiros do ContaAzul.
                    Certifique-se de que o sync categorizado foi executado nas configura·ß·µes.
                  </AlertDescription>
                </Alert>
              )}
            </TabsContent>
                ...
                <div className="space-y-6">
                  ...
                  <Card>
                    <CardHeader className="bg-gray-50">
                      <CardTitle className="text-gray-800">üìä DRE - Demonstra·ß·£o do Resultado do Exerc·≠cio</CardTitle>
                        ...
                        <table className="w-full">
                          ...
                          <tbody>
                            ...
                            <tr className="bg-green-50 border-t-2 border-green-200">
                              <td className="py-3 px-4 font-bold text-green-700">üí∞ RECEITAS</td>
                            ...
                            <tr className="bg-red-50 border-t-2 border-red-200">
                              <td className="py-3 px-4 font-bold text-red-700">üí∏ DESPESAS</td>
                ...
                <Card>
                  <CardContent className="py-8">
                    <div className="text-center">
                      ...
                      <h3 className="text-lg font-semibold mb-2">DRE - Demonstra·ß·£o do Resultado</h3>
                      <p className="text-gray-500 mb-4">
                        Selecione um m·™s e clique em "Atualizar DRE" para calcular a demonstra·ß·£o do resultado.
                      </p>
            ...
            <TabsContent value="insights" className="space-y-6">
              ...
              <Alert>
                ...
                <AlertDescription>
                  üí° Esta se·ß·£o ser·° desenvolvida com an·°lises avan·ßadas baseadas nos dados coletados. 
                  Incluir·° gr·°ficos de tend·™ncias, compara·ß·µes mensais e insights automatizados.
                </AlertDescription>
              </Alert>
            </TabsContent>
          </Tabs>
