    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="bg-white p-8 rounded-xl shadow-lg text-center max-w-md">
          ...
          <h2 className="text-xl font-semibold text-red-800 mb-2">Erro na Autorização</h2>
      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-800 mb-2">Autorização Google Concluída!</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">📋 Informações do Token</h3>
              <div className="space-y-3 text-sm">
                ...
                <div>
                  ...
                  <span className="ml-2 text-gray-800">{tokenData?.refresh_token ? '✅ Sim' : '❌ Não'}</span>
                </div>
            ...
            <div className="bg-green-50 rounded-lg p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-700">Pronto para sincronizar avaliações</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 bg-blue-50 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-blue-800 mb-3">📚 Como usar</h3>
            <div className="text-sm text-blue-700 space-y-2">
              <p><strong>1.</strong> O token foi salvo automaticamente no navegador</p>
              <p><strong>2.</strong> O script de sincronização agora pode acessar as avaliações completas</p>
              <p><strong>3.</strong> Execute: <code className="bg-blue-100 px-2 py-1 rounded">node scripts/sync_google_my_business.js</code></p>
              <p><strong>4.</strong> Configure um cron job para sincronização automática</p>
            </div>
          </div>
        </div>
      </div>
