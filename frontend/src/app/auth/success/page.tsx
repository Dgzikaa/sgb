...
export default function AuthSuccessPage() {
  ...
  useEffect(() => {
    ...
    if (!code) {
      setStatus('error')
      setError('CÃ³digo de autorizaÃ§Ã£o nÃ£o encontrado')
      return
    }
  ...
  const exchangeCodeForToken = async (code: string) => {
    try {
      ...
      // Testar acesso Ã s contas do My Business
      testMyBusinessAccess(tokenInfo.access_token)

    } catch (error) {
      console.error('âŒ Erro ao trocar cÃ³digo por token:', error)
      setStatus('error')
  ...
  const testMyBusinessAccess = async (accessToken: string) => {
    try {
      ...
      if (response.ok) {
        ...
        console.log('âœ… Acesso ao My Business confirmado!')
        console.log('ðŸ“‹ Contas encontradas:', accountsData.accounts?.length || 0)
        
        // Adicionar informaÃ§Ãµes das contas ao token
        ...
        console.warn('âš ï¸ Acesso limitado ao My Business')
      }
    } catch (error) {
      console.warn('âš ï¸ Erro ao testar My Business:', error)
    }
  }
  ...
  const copyTokenToClipboard = () => {
    if (tokenData) {
      ...
      alert('Token copiado para Ã¡rea de transferÃªncia!')
    }
  }

  const runSyncTest = async () => {
    try {
      console.log('ðŸ”„ Testando sincronizaÃ§Ã£o...')
      ...
      if (result.success) {
        alert(`âœ… Teste de sincronizaÃ§Ã£o bem-sucedido!\n${result.message}`)
      } else {
        alert(`âŒ Erro no teste: ${result.error}`)
      }
    } catch (error) {
      alert('âŒ Erro ao testar sincronizaÃ§Ã£o')
    }
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="bg-white p-8 rounded-xl shadow-lg text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-800 mb-2">Processando autorizaÃ§Ã£o...</h2>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="bg-white p-8 rounded-xl shadow-lg text-center max-w-md">
          <div className="text-red-500 text-4xl mb-4">âŒ</div>
          <h2 className="text-xl font-semibold text-red-800 mb-2">Erro na AutorizaÃ§Ã£o</h2>
      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-800 mb-2">AutorizaÃ§Ã£o Google ConcluÃ­da!</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">ðŸ“‹ InformaÃ§Ãµes do Token</h3>
              <div className="space-y-3 text-sm">
                ...
                <div>
                  ...
                  <span className="ml-2 text-gray-800">{tokenData?.refresh_token ? 'âœ… Sim' : 'âŒ NÃ£o'}</span>
                </div>
            ...
            <div className="bg-green-50 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-green-800 mb-4">ðŸŽ¯ PrÃ³ximos Passos</h3>
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-700">Pronto para sincronizar avaliaÃ§Ãµes</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8">
            <details className="bg-gray-50 rounded-lg p-4">
              <summary className="cursor-pointer font-medium text-gray-700 mb-2">
                ðŸ”§ Detalhes TÃ©cnicos do Token (Clique para expandir)
              </summary>
          ...
          <div className="mt-8 bg-blue-50 rounded-lg p-6">
            ...
            <div className="text-sm text-blue-700 space-y-2">
              ...
              <p><strong>2.</strong> O script de sincronizaÃ§Ã£o agora pode acessar as avaliaÃ§Ãµes completas</p>
              <p><strong>3.</strong> Execute: <code className="bg-blue-100 px-2 py-1 rounded">node scripts/sync_google_my_business.js</code></p>
              <p><strong>4.</strong> Configure um cron job para sincronizaÃ§Ã£o automÃ¡tica</p>
            </div>
          </div>
        </div>
      </div>
