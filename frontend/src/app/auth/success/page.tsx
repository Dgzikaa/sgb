...
export default function AuthSuccessPage() {
  ...
  useEffect(() => {
    ...
    if (!code) {
      setStatus('error')
      setError('Cá³digo de autorizaá§á£o ná£o encontrado')
      return
    }

    console.log('ðŸ”„ Trocando cá³digo por token...')
  ...
  const exchangeCodeForToken = async (code: string) => {
    try {
      ...
      console.log('œ… Token obtido com sucesso!')
      ...
      // Testar acesso á s contas do My Business
      testMyBusinessAccess(tokenInfo.access_token)

    } catch (error) {
      console.error('Œ Erro ao trocar cá³digo por token:', error)
      setStatus('error')
  ...
  const testMyBusinessAccess = async (accessToken: string) => {
    try {
      console.log('ðŸ” Testando acesso ao My Business...')
      ...
      if (response.ok) {
        ...
        console.log('œ… Acesso ao My Business confirmado!')
        console.log('ðŸ“‹ Contas encontradas:', accountsData.accounts?.length || 0)
        
        // Adicionar informaá§áµes das contas ao token
        ...
        console.warn('š ï¸ Acesso limitado ao My Business')
      }
    } catch (error) {
      console.warn('š ï¸ Erro ao testar My Business:', error)
    }
  }
  ...
  const runSyncTest = async () => {
    try {
      console.log('ðŸ”„ Testando sincronizaá§á£o...')
      ...
      if (result.success) {
        alert(`œ… Teste de sincronizaá§á£o bem-sucedido!\n${result.message}`)
      } else {
        alert(`Œ Erro no teste: ${result.error}`)
      }
    } catch (error) {
      alert('Œ Erro ao testar sincronizaá§á£o')
    }
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="bg-white p-8 rounded-xl shadow-lg text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-800 mb-2">Processando autorizaá§á£o...</h2>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="bg-white p-8 rounded-xl shadow-lg text-center max-w-md">
          <div className="text-red-500 text-4xl mb-4">Œ</div>
          <h2 className="text-xl font-semibold text-red-800 mb-2">Erro na Autorizaá§á£o</h2>
      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="text-center mb-8">
            <div className="text-green-500 text-4xl mb-4">œ…</div>
            <h1 className="text-2xl font-bold text-gray-800 mb-2">Autorizaá§á£o Google Concluá­da!</h1>
            <p className="text-gray-600">Token OAuth obtido com sucesso para acessar Google My Business</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Informaá§áµes do Token */}
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">ðŸ“‹ Informaá§áµes do Token</h3>
              <div className="space-y-3 text-sm">
                ...
                <div>
                  ...
                  <span className="ml-2 text-gray-800">{tokenData?.refresh_token ? 'œ… Sim' : 'Œ Ná£o'}</span>
                </div>
            ...
            <div className="bg-green-50 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-green-800 mb-4">ðŸŽ¯ Prá³ximos Passos</h3>
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-700">Pronto para sincronizar avaliaá§áµes</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 bg-blue-50 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-blue-800 mb-3">ðŸ“š Como usar</h3>
            <div className="text-sm text-blue-700 space-y-2">
              <p><strong>1.</strong> O token foi salvo automaticamente no navegador</p>
              <p><strong>2.</strong> O script de sincronizaá§á£o agora pode acessar as avaliaá§áµes completas</p>
              <p><strong>3.</strong> Execute: <code className="bg-blue-100 px-2 py-1 rounded">node scripts/sync_google_my_business.js</code></p>
              <p><strong>4.</strong> Configure um cron job para sincronizaá§á£o automá¡tica</p>
            </div>
          </div>
        </div>
      </div>
