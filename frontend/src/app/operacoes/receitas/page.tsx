  ...
  const carregarInsumos = useCallback(async () => {
    ...
    try {
      ...
      if (data.success && data.data) {
        ...
        const insumosFormatados = data.data.map((insumo: Record<string, unknown>) => ({
          ...
          unidade_medida: insumo.unidade as string || insumo.unidade_medida as string || 'g',
        ...
        const cozinhaCount = insumosFormatados.filter((i: Record<string, unknown>) => i.tipo_local === 'cozinha').length
        const barCount = insumosFormatados.filter((i: Record<string, unknown>) => i.tipo_local === 'bar').length
