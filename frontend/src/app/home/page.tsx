        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="welcome-header text-2xl font-bold text-gray-900 dark:text-white mb-1">
              Bem-vindo de volta! Ã°Å¸â€˜â€¹
            </h1>
            <p className="text-gray-500 dark:text-gray-400">
              VisÃ¡Â£o geral do <strong className="text-gray-700 dark:text-gray-200">{selectedBar?.nome}</strong> - {new Date().toLocaleDateString('pt-BR')}
            </p>
          </div>
