...
export function UserProvider({ children }: { children: React.ReactNode }) {
  ...
  // Carregar dados do usuá¡rio ao inicializar
  useEffect(() => {
  ...
  // Configurar listeners para atualizaá§áµes
  useEffect(() => {
  ...
  const loadUserData = () => {
    ...
    try {
      ...
      if (userData) {
        ...
        // Validar se os dados do usuá¡rio sá£o vá¡lidos
      ...
      console.error('Œ Erro ao carregar dados do usuá¡rio:', error)
  ...
  const refreshUser = async (): Promise<void> => {
    ...
    try {
      ...
      console.error('Erro ao recarregar dados do usuá¡rio:', error)
      setUser(null)
    }
  }
