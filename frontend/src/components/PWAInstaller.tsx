...
export function PWAInstaller({ 
  ...
  useEffect(() => {
    ...
    const handleAppInstalled = () => {
      ...
      console.log('Å“â€¦ PWA: App installed successfully')
    }
  ...
  const handleInstallClick = async () => {
    ...
    try {
      ...
      if (outcome === 'accepted') {
        console.log('Å“â€¦ PWA: User accepted installation')
        onInstall?.()
      } else {
        console.log('ÂÅ’ PWA: User dismissed installation')
        onDismiss?.()
      }
      ...
      console.error('ÂÅ’ PWA: Installation error:', error)
    }
  }
