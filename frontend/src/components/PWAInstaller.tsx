...
export function PWAInstaller({ 
  ...
  useEffect(() => {
    ...
    const handleAppInstalled = () => {
      ...
      console.log('œ… PWA: App installed successfully')
    }
  ...
  const handleInstallClick = async () => {
    ...
    try {
      ...
      if (outcome === 'accepted') {
        console.log('œ… PWA: User accepted installation')
        onInstall?.()
      } else {
        console.log('Œ PWA: User dismissed installation')
        onDismiss?.()
      }
      ...
      console.error('Œ PWA: Installation error:', error)
    }
  }
