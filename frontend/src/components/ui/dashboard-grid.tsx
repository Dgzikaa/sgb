...
export function DashboardGrid({ 
  ...
  const findEmptyPosition = (): { x: number; y: number } => {
    // Simples algoritmo para encontrar posiÃ¡Â§Ã¡Â£o vazia
          ...
          <div className="col-span-full flex items-center justify-center py-12">
            <div className="text-center">
              ...
              <h3 className="font-medium text-gray-900 dark:text-white mb-2">
                Nenhum widget visÃ¡Â­vel
              </h3>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Adicione widgets ou torne alguns visÃ¡Â­veis para comeÃ¡Â§ar
              </p>
              <Button
      ...
      {isEditing && (
        <div className="flex items-center gap-2 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
          ...
          <span className="text-sm text-blue-800 dark:text-blue-200">
            Modo de ediÃ¡Â§Ã¡Â£o ativo: arraste widgets para reposicionar, use os controles para configurar ou remover
          </span>
        </div>
      )}
    </div>
      ...
      return (
        <div className="space-y-2">
          ...
          <div className="text-xs text-gray-600 dark:text-gray-400">
            Ã¡Å¡ltima atualizaÃ¡Â§Ã¡Â£o: agora
          </div>
        </div>
      )
