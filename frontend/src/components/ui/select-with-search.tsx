...
export function SelectWithSearch({
  ...
  value,
  onValueChange,
  placeholder = "Selecione uma opá§á£o",
            ...
            <>
              <div className="w-8 h-8 bg-indigo-100 rounded-full flex items-center justify-center">
                {selectedOption.avatar ? (
                  <img src={selectedOption.avatar} alt={selectedOption.label} className="w-full h-full rounded-full object-cover" />
                ) : (
                    ...
                    {option.role && (
                      ...
                      `}>
                        {option.role === 'admin' ? 'Administrador' : 
                         option.role === 'manager' ? 'Gerente' : 'Funcioná¡rio'}
                      </span>
                    )}
                  </div>
                </button>
