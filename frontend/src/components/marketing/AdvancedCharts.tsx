...
// ========================================
// Ã°Å¸â€œÅ  ADVANCED MARKETING CHARTS
// ========================================
// Componente de grÃ¡Â¡ficos avanÃ¡Â§ados para anÃ¡Â¡lise de tendÃ¡Âªncias
...
// ========================================
// Ã°Å¸â€œÅ  DADOS SIMULADOS PARA DEMONSTRAÃ¡â€¡Ã¡Æ’O
// ========================================
...
const generateWeeklyData = () => {
  const days = ['Seg', 'Ter', 'Qua', 'Qui', 'Sex', 'SÃ¡Â¡b', 'Dom']
...
const generateEngagementBreakdown = () => [
  ...
  { tipo: 'ComentÃ¡Â¡rios', valor: 456, cor: CHART_COLORS.primary },
...
const generatePerformanceRadar = () => [
  ...
  { metrica: 'Qualidade do ConteÃ¡Âºdo', instagram: 88, facebook: 75, fullMark: 100 },
  { metrica: 'FrequÃ¡Âªncia de Posts', instagram: 75, facebook: 60, fullMark: 100 },
  { metrica: 'InteraÃ¡Â§Ã¡Â£o', instagram: 82, facebook: 68, fullMark: 100 }
]
...
export default function AdvancedCharts({ trendData, campaignData, timeRange = 'month' }: AdvancedChartsProps) {
  ...
  // ========================================
  // Ã°Å¸â€œË† GRÃ¡ÂFICO DE TENDÃ¡Å NCIAS
  // ========================================
  const TrendsChart = () => (
    <Card className="card-dark bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg">
      <CardHeader>
        <CardTitle className="card-title-dark flex items-center gap-2">
          ...
          EvoluÃ¡Â§Ã¡Â£o de Seguidores e MÃ¡Â©tricas
        </CardTitle>
        <CardDescription className="card-description-dark">
          EvoluÃ¡Â§Ã¡Â£o diÃ¡Â¡ria de seguidores, impressÃ¡Âµes, gasto e cliques
        </CardDescription>
      </CardHeader>
      <CardContent>
        <ResponsiveContainer width="100%" height={350}>
          <AreaChart data={trends} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
            ...
            <Area type="monotone" dataKey="total_impressions" stroke={CHART_COLORS.info} fillOpacity={0.2} fill={CHART_COLORS.info} name="ImpressÃ¡Âµes" strokeDasharray="5 5" />
  ...
  // ========================================
  // Ã°Å¸â€œÅ  GRÃ¡ÂFICO DE ENGAJAMENTO
  // ========================================
  ...
  // ========================================
  // Ã°Å¸Â¥Â§ BREAKDOWN DE ENGAJAMENTO
  // ========================================
    ...
    <Card className="card-dark bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg">
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          Tipos de InteraÃ¡Â§Ã¡Â£o
        </CardTitle>
        <CardDescription>
          DistribuiÃ¡Â§Ã¡Â£o das formas de engajamento
        </CardDescription>
      </CardHeader>
      <CardContent>
        <ResponsiveContainer width="100%" height={300}>
          <PieChart>
            ...
            <Tooltip 
              formatter={(value) => [value.toLocaleString(), 'InteraÃ¡Â§Ã¡Âµes']}
            />
            <Legend />
          </PieChart>
        </ResponsiveContainer>
  ...
  const PerformanceRadar = () => (
    <Card className="card-dark bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg">
      <CardHeader>
        ...
        <CardDescription>
          AnÃ¡Â¡lise multidimensional das mÃ¡Â©tricas
        </CardDescription>
      </CardHeader>
      <CardContent>
        <ResponsiveContainer width="100%" height={350}>
  ...
  const WeeklyActivity = () => (
    <Card className="card-dark bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg">
      <CardHeader>
        ...
        <CardDescription>
          PadrÃ¡Âµes de engajamento por dia da semana
        </CardDescription>
      </CardHeader>
      <CardContent>
        <ResponsiveContainer width="100%" height={300}>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">
            Ã°Å¸â€œÅ  AnÃ¡Â¡lise AvanÃ¡Â§ada de Marketing
          </h2>
          <p className="text-gray-600">
            Insights detalhados e tendÃ¡Âªncias das redes sociais
          </p>
        </div>
      ...
      {/* Tabs para diferentes anÃ¡Â¡lises */}
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/30 dark:to-purple-900/30 border border-gray-200 dark:border-gray-700 grid w-full grid-cols-4">
          <TabsTrigger value="trends">Ã°Å¸â€œË† TendÃ¡Âªncias</TabsTrigger>
          <TabsTrigger value="engagement">ÂÂ¤Ã¯Â¸Â Engajamento</TabsTrigger>
          <TabsTrigger value="breakdown">Ã°Å¸Â¥Â§ DistribuiÃ¡Â§Ã¡Â£o</TabsTrigger>
          <TabsTrigger value="performance">Ã°Å¸Å½Â¯ Performance</TabsTrigger>
        </TabsList>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="p-4 bg-green-50 rounded-lg">
              ...
              <p className="text-sm text-green-700">
                Instagram cresceu 23% este mÃ¡Âªs, superando a meta de 15%
              </p>
            </div>
            ...
            <div className="p-4 bg-blue-50 rounded-lg">
              ...
              <p className="text-sm text-blue-700">
                Sexta-feira tem o maior engajamento (34% acima da mÃ¡Â©dia)
              </p>
            </div>
            ...
            <div className="p-4 bg-purple-50 rounded-lg">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-medium text-purple-800">ConteÃ¡Âºdo Popular</span>
              </div>
              <p className="text-sm text-purple-700">
                Posts com drinks especiais tÃ¡Âªm 45% mais curtidas
              </p>
            </div>
          </div>
        </CardContent>
        ...
        <Card key={post.id} className="card-dark p-0 overflow-hidden shadow-lg hover:scale-[1.02] transition-transform">
          ...
          <CardContent className="p-4">
            ...
            <div className="font-semibold card-title-dark text-base mb-2 line-clamp-2">
              {post.caption || post.message || 'Post sem descriÃ¡Â§Ã¡Â£o'}
            </div>
