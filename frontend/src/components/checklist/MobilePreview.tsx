...
// =====================================================
// Ã°Å¸â€œÂ± PREVIEW MOBILE PARA CHECKLIST
// =====================================================
// Mostra como o checklist ficarÃ¡Â¡ no celular durante a criaÃ¡Â§Ã¡Â£o
      ...
      case 'assinatura':
        return (
          <div className="border-2 border-dashed border-gray-300 rounded-lg h-32 flex items-center justify-center">
            <span className="text-gray-500">Å“ÂÃ¯Â¸Â Ã¡Ârea de Assinatura</span>
          </div>
        )
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-full max-h-full overflow-hidden">
        ...
        {/* Footer com InformaÃ¡Â§Ã¡Âµes */}
        <div className="p-4 border-t bg-gray-50 text-center">
          <p className="text-sm text-gray-600">
            Ã°Å¸â€œÂ± Preview: {deviceType} â‚¬Â¢ {itens.length} itens â‚¬Â¢ Zoom: {Math.round(zoom * 100)}%
          </p>
        </div>
      </div>
    </div>
...
// =====================================================
// Ã°Å¸Å½Â¯ HOOK PARA GERENCIAR PREVIEW
// =====================================================
