...
// =====================================================
// Ã°Å¸â€œÂ± COPIAR ITENS ENTRE CHECKLISTS (MOBILE-FRIENDLY)
// =====================================================
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                >
                  <option value="">Todas as seÃ¡Â§Ã¡Âµes</option>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Label htmlFor="only-required" className="text-sm">
                    Apenas obrigatÃ¡Â³rios
                  </Label>
                </div>
              </div>
            </div>

            {/* BotÃ¡Â£o Selecionar Todos */}
        ...
        return (
          <div className="space-y-4">
            <div className="text-center p-4 bg-green-50 rounded-lg">
              <div className="text-2xl mb-2">Å“â€¦</div>
              <div className="text-sm font-medium">
                Confirmar cÃ¡Â³pia de itens
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <Label className="text-sm font-medium text-gray-700">Itens que serÃ¡Â£o copiados:</Label>
...
// =====================================================
// Ã°Å¸Å½Â¯ HOOK PARA GERENCIAR CÃ¡â€œPIA DE ITENS
// =====================================================
      ...
      const response = await fetch('/api/checklists/copy-items', {
        ...
        body: JSON.stringify({
          ...
          items: items.map((item) => ({
            ...
            ordem: undefined // SerÃ¡Â¡ definido automaticamente
          }))
        }),
      })
