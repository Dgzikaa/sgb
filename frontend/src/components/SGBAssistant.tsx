...
async function analyzeToday(barInfo: BarInfo | null): Promise<{
  content: string;
...
async function analyzeWeek(barInfo: BarInfo | null): Promise<{
  content: string;
  metadata?: { command?: string; data?: Record<string, unknown> };
}> {
  return {
...
async function detectAnomalies(barInfo: BarInfo | null): Promise<{
  content: string;
  metadata?: { command?: string; data?: Record<string, unknown> };
}> {
  return {
...
async function generateSuggestions(barInfo: BarInfo | null): Promise<{
  content: string;
  metadata?: { command?: string; data?: Record<string, unknown> };
}> {
  return {
