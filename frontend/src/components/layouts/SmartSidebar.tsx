...
export function SmartSidebar({ isCollapsed = false, onToggle }: SmartSidebarProps) {
  ...
  const menuItems: MenuItem[] = [
    // Main navigation
    {
      ...
      category: 'main',
      importance: 'high',
      keywords: ['inÃ¡Â­cio', 'principal', 'dashboard']
    },
    {
    ...
    //   category: 'main',
    //   importance: 'high',
    //   keywords: ['visÃ¡Â£o', 'geral', 'overview', 'mÃ¡Â©tricas']
    // },
    ...
    // Checklists
    {
      ...
      category: 'main',
      importance: 'high',
      keywords: ['checklists', 'verificaÃ¡Â§Ã¡Â£o', 'templates'],
      subItems: [
        {
          ...
          category: 'main',
          importance: 'high',
          keywords: ['checklist', 'abertura', 'verificaÃ¡Â§Ã¡Â£o']
        },
        {
          id: 'templates-main',
          title: 'Templates',
    ...
    // Operations
    {
      ...
      category: 'operations',
      importance: 'high',
      keywords: ['operaÃ¡Â§Ã¡Âµes', 'operacional', 'gestÃ¡Â£o'],
      subItems: [
        {
        ...
        },
        {
          ...
          category: 'operations',
          importance: 'medium',
          keywords: ['receitas', 'produtos', 'cardÃ¡Â¡pio']
        },
        {
          id: 'tempo',
          title: 'GestÃ¡Â£o de Tempo',
          icon: Clock,
          href: '/operacoes/tempo',
          category: 'operations',
          importance: 'medium',
          keywords: ['tempo', 'cronÃ¡Â´metro', 'produtividade']
        }
      ]
    },
    ...
    {
      id: 'producao',
      title: 'ProduÃ¡Â§Ã¡Â£o',
      icon: Cpu,
      href: '/producao',
      category: 'operations',
      importance: 'high',
      keywords: ['produÃ¡Â§Ã¡Â£o', 'terminal', 'cozinha'],
      subItems: [
        {
          id: 'terminal',
          ...
          category: 'operations',
          importance: 'high',
          keywords: ['terminal', 'produÃ¡Â§Ã¡Â£o', 'cozinha']
        },
        {
    ...
    // Reports
    {
      ...
      category: 'reports',
      importance: 'high',
      keywords: ['relatÃ¡Â³rios', 'reports', 'anÃ¡Â¡lise'],
      subItems: [
        {
    ...
    // Configuration
    {
      ...
      importance: 'medium',
      requiredRole: 'admin',
      keywords: ['configuraÃ¡Â§Ã¡Âµes', 'config', 'admin'],
      subItems: [
        {
        ...
        },
        {
          ...
          category: 'config',
          importance: 'medium',
          keywords: ['integraÃ¡Â§Ã¡Âµes', 'apis', 'conexÃ¡Âµes']
        },
        {
          id: 'analytics',
          title: 'Analytics',
          ...
          category: 'config',
          importance: 'medium',
          keywords: ['analytics', 'mÃ¡Â©tricas', 'dashboard', 'performance']
        },
        {
          id: 'cache',
          title: 'Cache',
          ...
          category: 'config',
          importance: 'medium',
          keywords: ['cache', 'redis', 'performance', 'memÃ¡Â³ria']
        },
        {
          id: 'seguranca',
          title: 'SeguranÃ¡Â§a',
          ...
          category: 'config',
          importance: 'high',
          keywords: ['seguranÃ¡Â§a', 'proteÃ¡Â§Ã¡Â£o', 'acesso']
        }
      ]
    }
  ]

  // Detectar contexto de navegaÃ¡Â§Ã¡Â£o
  ...
  // Adicionar Ã¡Â  lista de favoritos
  ...
  const categoryLabels = {
    main: 'Principal',
    operations: 'OperaÃ¡Â§Ã¡Âµes',
    reports: 'RelatÃ¡Â³rios',
    config: 'ConfiguraÃ¡Â§Ã¡Âµes',
    admin: 'AdministraÃ¡Â§Ã¡Â£o'
  }
        ...
        <div className="p-4 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-medium text-gray-600 dark:text-gray-400">
              ...
              {context.workflowState === 'production' && 'ProduÃ¡Â§Ã¡Â£o'}
              {context.workflowState === 'closing' && 'Fechamento'}
              {context.workflowState === 'reports' && 'RelatÃ¡Â³rios'}
        ...
        {!isCollapsed && (
          <div className="text-xs text-gray-500 dark:text-gray-400">
            <div className="flex items-center gap-1">
              ...
              <span>NavegaÃ¡Â§Ã¡Â£o Inteligente</span>
            </div>
            <div className="mt-1">
...
// Componente para item de navegaÃ¡Â§Ã¡Â£o
function NavItem({ 
  item, 
  isCollapsed, 
  isActive, 
