...
const routeMapping: Record<string, { name: string; icon?: React.ComponentType<{ className?: string }> }> = {
  ...
  // ProduÃ¡Â§Ã¡Â£o
  '/producao': { name: 'ProduÃ¡Â§Ã¡Â£o' },
  '/producao/receitas': { name: 'Receitas e Insumos' },
  '/producao/terminal': { name: 'Terminal de ProduÃ¡Â§Ã¡Â£o' },
  
  // ContaAzul
  '/relatorios/financeiro-competencia': { name: 'CompetÃ¡Âªncia' },
  
  // Marketing
  '/visao-geral/marketing-360': { name: 'Marketing 360' },
  
  // FuncionÃ¡Â¡rio
  '/funcionario': { name: 'FuncionÃ¡Â¡rio' },
  '/funcionario/checklists': { name: 'Meus Checklists' },
  
  // ConfiguraÃ¡Â§Ã¡Âµes (apenas admin)
  '/configuracoes': { name: 'ConfiguraÃ¡Â§Ã¡Âµes' },
  '/configuracoes/checklists': { name: 'Checklists' },
  '/configuracoes/metas': { name: 'Metas' },
  '/configuracoes/integracoes': { name: 'IntegraÃ¡Â§Ã¡Âµes' },
  '/configuracoes/seguranca': { name: 'SeguranÃ¡Â§a' },
...
export function DarkHeader() {
  ...
  // Removendo o useEffect local para dark mode, pois agora Ã¡Â© gerenciado pelo contexto
  ...
  //     message: 'Aguardando preenchimento por JoÃ¡Â£o Silva',
  //     time: '5 min atrÃ¡Â¡s',
  //     unread: true
  //   },
  //   {
  //     id: 2,
  //     title: 'SincronizaÃ¡Â§Ã¡Â£o ContaAzul',
  //     message: 'Dados atualizados com sucesso',
  //     time: '1 hora atrÃ¡Â¡s',
  //     unread: false
  //   },
  //   {
  //     id: 3,
  //     title: 'Nova Reserva',
  //     message: 'Mesa para 4 pessoas Ã¡Â s 20:00',
  //     time: '2 horas atrÃ¡Â¡s',
  //     unread: true
  //   }
  // ]
