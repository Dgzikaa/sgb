        ...
        <div className="space-y-4 py-4">
          <div>
            ...
            <div className="mt-1 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">CPF/CNPJ: {stakeholder.document}</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-2">
            ...
            />
            <Label htmlFor="is-cpf-cnpj" className="text-gray-700 dark:text-gray-300">
              Chave PIX é o mesmo CPF/CNPJ?
            </Label>
          </div>

          <div>
            <Label htmlFor="pix-key" className="text-gray-700 dark:text-gray-300">
              Chave PIX *
            </Label>
            <Input
              id="pix-key"
