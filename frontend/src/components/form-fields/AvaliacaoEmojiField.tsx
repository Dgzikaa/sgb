...
// =====================================================
// Ã°Å¸Å½Â­ CAMPO DE AVALIAÃ¡â€¡Ã¡Æ’O COM EMOJIS/CARINHAS
// =====================================================
// Implementa conforme documento Word:
// "O campo de avaliaÃ¡Â§Ã¡Â£o eu gosto de poder usar as carinhas"
...
// ConfiguraÃ¡Â§Ã¡Âµes dos diferentes tipos de avaliaÃ¡Â§Ã¡Â£o
const avaliacaoConfigs = {
  emojis: {
    opcoes: [
      { valor: 1, emoji: 'Ã°Å¸ËœÂ¢', label: 'Muito ruim', cor: 'text-red-500' },
      { valor: 2, emoji: 'Ã°Å¸Ëœâ€¢', label: 'Ruim', cor: 'text-orange-500' },
      { valor: 3, emoji: 'Ã°Å¸ËœÂ', label: 'Regular', cor: 'text-yellow-500' },
      { valor: 4, emoji: 'Ã°Å¸ËœÅ ', label: 'Bom', cor: 'text-blue-500' },
      { valor: 5, emoji: 'Ã°Å¸ËœÂ', label: 'Excelente', cor: 'text-green-500' }
    ]
  },
  faces: {
    opcoes: [
      { valor: 1, emoji: 'ËœÂ¹Ã¯Â¸Â', label: 'Insatisfeito', cor: 'text-red-500' },
      { valor: 2, emoji: 'Ã°Å¸ËœÅ¾', label: 'Pouco satisfeito', cor: 'text-orange-500' },
      { valor: 3, emoji: 'Ã°Å¸ËœÂ', label: 'Neutro', cor: 'text-yellow-500' },
      { valor: 4, emoji: 'Ã°Å¸â„¢â€š', label: 'Satisfeito', cor: 'text-blue-500' },
      { valor: 5, emoji: 'Ã°Å¸ËœÂ', label: 'Muito satisfeito', cor: 'text-green-500' }
    ]
  },
  qualidade: {
    opcoes: [
      { valor: 1, emoji: 'Ã°Å¸â€™â€', label: 'PÃ¡Â©ssimo', cor: 'text-red-500' },
      { valor: 2, emoji: 'Ã°Å¸â€˜Å½', label: 'Ruim', cor: 'text-orange-500' },
      { valor: 3, emoji: 'Ã°Å¸â€˜Å’', label: 'AceitÃ¡Â¡vel', cor: 'text-yellow-500' },
      { valor: 4, emoji: 'Ã°Å¸â€˜Â', label: 'Bom', cor: 'text-blue-500' },
      { valor: 5, emoji: 'Ã°Å¸Ââ€ ', label: 'Perfeito', cor: 'text-green-500' }
    ]
  },
  estrelas: {
    opcoes: [
      { valor: 1, emoji: 'Â­Â', label: '1 estrela', cor: 'text-yellow-500' },
      { valor: 2, emoji: 'Â­ÂÂ­Â', label: '2 estrelas', cor: 'text-yellow-500' },
      { valor: 3, emoji: 'Â­ÂÂ­ÂÂ­Â', label: '3 estrelas', cor: 'text-yellow-500' },
      { valor: 4, emoji: 'Â­ÂÂ­ÂÂ­ÂÂ­Â', label: '4 estrelas', cor: 'text-yellow-500' },
      { valor: 5, emoji: 'Â­ÂÂ­ÂÂ­ÂÂ­ÂÂ­Â', label: '5 estrelas', cor: 'text-yellow-500' }
    ]
  }
}
        ...
        <div className="text-center min-h-[2rem] flex items-center justify-center">
          ...
          {!value && !hoveredValue && (
            <div className="text-gray-400 text-sm">
              {obrigatorio ? 'Selecione uma avaliaÃ¡Â§Ã¡Â£o' : 'AvaliaÃ¡Â§Ã¡Â£o opcional'}
            </div>
          )}
        </div>
      </div>
...
// =====================================================
// Ã°Å¸Å½Â¨ VARIANTES PRÃ¡â€°-CONFIGURADAS
// =====================================================
...
// =====================================================
// Ã°Å¸â€Â§ HOOK PARA GERENCIAR AVALIAÃ¡â€¡Ã¡â€¢ES
// =====================================================
...
export function useAvaliacaoEmoji(valorInicial?: number) {
  ...
  const isValid = (obrigatorio = false) => {
