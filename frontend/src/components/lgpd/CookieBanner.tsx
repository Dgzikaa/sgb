          ...
          <CardContent className="p-6 space-y-6">
            <div className="text-center">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">
                Ã°Å¸â€â€™ ConfiguraÃ¡Â§Ã¡Âµes de Privacidade
              </h2>
              <p className="text-gray-600 dark:text-gray-400">
                Gerencie suas preferÃ¡Âªncias de cookies conforme a LGPD
              </p>
            </div>

            <div className="space-y-4">
              {[
                { type: 'essential', name: 'Essenciais', description: 'NecessÃ¡Â¡rios para funcionamento', required: true },
                { type: 'analytics', name: 'Analytics', description: 'AnÃ¡Â¡lise de uso', required: false },
                { type: 'marketing', name: 'Marketing', description: 'Publicidade personalizada', required: false },
                { type: 'preferences', name: 'PreferÃ¡Âªncias', description: 'ConfiguraÃ¡Â§Ã¡Âµes pessoais', required: false },
                ...
                <div key={cookie.type} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                  <div>
                    <h3 className="font-medium text-gray-900 dark:text-white">
                      {cookie.name}
                      {cookie.required && <Badge className="ml-2 text-xs bg-red-100 text-red-800">ObrigatÃ¡Â³rio</Badge>}
                    </h3>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 p-4 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 shadow-2xl">
        <Card className="max-w-6xl mx-auto border-none shadow-none bg-transparent">
          <CardContent className="p-6">
            <div className="flex flex-col lg:flex-row items-start lg:items-center gap-4">
              ...
              <div className="flex-1 space-y-3">
                <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
                  ...
                  personalizar conteÃ¡Âºdo e analisar o trÃ¡Â¡fego. VocÃ¡Âª pode escolher quais cookies 
                  aceitar conforme seus direitos da <strong>LGPD</strong>.
                </p>
                
                <div className="flex flex-wrap items-center gap-2">
                  <span className="text-xs text-gray-500 dark:text-gray-400">
                    Seus dados sÃ¡Â£o tratados com seguranÃ¡Â§a conforme nossa
                  </span>
                  <button 
            ...
            {/* InformaÃ¡Â§Ã¡Âµes legais */}
            <div className="mt-4 pt-3 border-t border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400">
                <span>Ã°Å¸â€â€™ Dados criptografados e seguros</span>
                <span>Ã°Å¸â€œÅ¾ DPO: privacy@seusite.com</span>
                <span>Å¡â€“Ã¯Â¸Â Conforme LGPD nÂº 13.709/2018</span>
              </div>
            </div>
          </CardContent>
        </Card>
