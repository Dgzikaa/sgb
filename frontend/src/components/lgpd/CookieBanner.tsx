          ...
          <CardContent className="p-6 space-y-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Gerencie suas preferÃªncias de cookies conforme a LGPD
              </p>
            </div>

            <div className="space-y-4">
              {[
                { type: 'essential', name: 'Essenciais', description: 'NecessÃ¡rios para funcionamento', required: true },
                { type: 'analytics', name: 'Analytics', description: 'AnÃ¡lise de uso', required: false },
                { type: 'marketing', name: 'Marketing', description: 'Publicidade personalizada', required: false },
                { type: 'preferences', name: 'PreferÃªncias', description: 'ConfiguraÃ§Ãµes pessoais', required: false },
                ...
                <div key={cookie.type} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                  <div>
                    <h3 className="font-medium text-gray-900 dark:text-white">
                      {cookie.name}
                      {cookie.required && <Badge className="ml-2 text-xs bg-red-100 text-red-800">ObrigatÃ³rio</Badge>}
                    </h3>
          ...
          <CardContent className="p-6">
            <div className="flex flex-col lg:flex-row items-start lg:items-center gap-4">
              ...
              <div className="flex-1 space-y-3">
                <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
                  ...
                  personalizar conteÃºdo e analisar o trÃ¡fego. VocÃª pode escolher quais cookies 
                  aceitar conforme seus direitos da <strong>LGPD</strong>.
                </p>
                
                <div className="flex flex-wrap items-center gap-2">
                  <span className="text-xs text-gray-500 dark:text-gray-400">
                    Seus dados sÃ£o tratados com seguranÃ§a conforme nossa
                  </span>
                  <button 
            ...
            <div className="mt-4 pt-3 border-t border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400">
                ...
                <span>âš–ï¸ Conforme LGPD nÂº 13.709/2018</span>
              </div>
            </div>
          </CardContent>
        </Card>
