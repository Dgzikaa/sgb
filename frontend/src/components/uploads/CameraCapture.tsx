...
export default function CameraCapture({ 
  ...
  const startCamera = useCallback(async () => {
    try {
      ...
      console.error('Erro ao acessar cá¢mera:', err)
      setError('Ná£o foi possá­vel acessar a cá¢mera. Verifique as permissáµes.')
    }
  }, [facingMode])

  // Parar stream da cá¢mera
  ...
  const capturePhoto = useCallback(() => {
    ...
    // Definir tamanho do canvas baseado no vá­deo
  ...
  // Alternar cá¢mera frontal/traseira
  const toggleCamera = useCallback(() => {
    setFacingMode(prev => prev === 'user' ? 'environment' : 'user')
  }, [])

  // Efeitos para gerenciar o ciclo de vida da cá¢mera
  useEffect(() => {
