...
export default function PhotoUpload({
  ...
  // FunÃ¡Â§Ã¡Â£o para capturar foto da cÃ¡Â¢mera
  ...
  // FunÃ¡Â§Ã¡Â£o para upload de arquivo
    ...
    try {
      ...
      for (const file of files) {
        try {
          ...
          console.log('Å“â€¦ Upload concluÃ¡Â­do:', result.filename)
  ...
  // Verificar se hÃ¡Â¡ uploads em progresso
  ...
  return (
    <div className={`space-y-4 ${className}`}>
      ...
      {/* InformaÃ¡Â§Ã¡Âµes sobre upload */}
      <div className="text-xs text-gray-500 space-y-1">
        <p>Ã°Å¸â€œÂ¸ Formatos aceitos: JPEG, PNG, WebP</p>
        <p>Ã°Å¸â€œÂ Tamanho mÃ¡Â¡ximo: 10MB por foto</p>
        {compress && (
          <p>Ã°Å¸â€”Å“Ã¯Â¸Â CompressÃ¡Â£o automÃ¡Â¡tica ativada (mÃ¡Â¡x. {maxWidth}px, qualidade {Math.round(quality * 100)}%)</p>
        )}
      </div>
