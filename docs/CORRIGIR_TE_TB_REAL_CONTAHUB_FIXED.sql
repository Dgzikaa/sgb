-- CORREÇÃO IMEDIATA TE.REAL E TB.REAL - VERSÃO CORRIGIDA
...
-- 3. Atualizar eventos com valores corretos (VR_LIQUIDO!)
UPDATE eventos 
SET 
  te_real = (
    SELECT CASE 
