-- FUNÇÃO update_eventos_after_contahub_processing() COM COLUNAS QUE EXISTEM
-- Execute este SQL no Supabase SQL Editor:

-- 1. Deletar função antiga
DROP FUNCTION IF EXISTS update_eventos_after_contahub_processing(date, integer);

-- 2. Criar função nova APENAS com colunas que existem
...
BEGIN
    ...
    SET
        ...
        -- tb_real NÃO EXISTE - usar tb_real_contahub
