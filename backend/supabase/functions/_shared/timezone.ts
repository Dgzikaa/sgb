// =====================================================
// ðŸ‡§ðŸ‡· TIMEZONE UTILS PARA EDGE FUNCTIONS - BRASáLIA
...
export function agoraEdgeFunction(): Date {
  // Edge functions rodam em UTC, entá£o convertemos manualmente
  const utcNow = new Date();
  const brasilOffset = -3; // UTC-3 (Brasá­lia)
...
/**
 * Formata data no padrá£o brasileiro para Edge Functions
 */
...
/**
 * Formata data e hora no padrá£o brasileiro para Edge Functions
 */
